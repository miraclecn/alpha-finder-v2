...
def _create_fundamental_source_db(path: Path, trade_dates: list[str]) -> None:
    ...
    conn.executemany(
        ...
        """,
        [
            ("600001.SH", "600001", "Bank Alpha", "SH", "main_board", "涓婃捣", "20200102", None, "N", True),
            ("600002.SH", "600002", "Bank Beta", "SH", "main_board", "涓婃捣", "20200102", None, "N", True),
            ("600003.SH", "600003", "Tech Gamma", "SH", "main_board", "涓婃捣", "20200102", None, "N", True),
            ("600004.SH", "600004", "Tech Delta", "SH", "main_board", "涓婃捣", "20200102", None, "N", True),
        ],
    )
    conn.executemany(
        """
