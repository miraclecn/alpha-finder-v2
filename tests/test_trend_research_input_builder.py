...
def _create_research_source_db(
    ...
    conn.executemany(
        ...
        """,
        [
            ("600001.SH", "600001", "Alpha Leader", "SH", "main_board", "涓婃捣", "20200102", None, "N", True),
            ("600002.SH", "600002", "Beta Runner", "SH", "main_board", "涓婃捣", "20200102", None, "N", True),
            ("600003.SH", "600003", "ST Ghost", "SH", "main_board", "涓婃捣", "20200102", None, "N", True),
            ("600004.SH", "600004", "New Listing", "SH", "main_board", "涓婃捣", "20240515", None, "N", True),
            ("600005.SH", "600005", "Illiquid Drift", "SH", "main_board", "涓婃捣", "20200102", None, "N", True),
        ],
    )
            ...
            case_path.write_text(
                "\n".join(
                    [
                        ...
                        f'output_path = "{(temp_root / "trend_input.json").as_posix()}"',
            ...
            case_path.write_text(
                "\n".join(
                    [
                        ...
                        f'source_db_path = "{source_db.as_posix()}"',
                        f'output_path = "{(temp_root / "liquid_midcap_input.json").as_posix()}"',
